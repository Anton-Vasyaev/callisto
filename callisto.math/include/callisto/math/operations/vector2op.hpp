...
struct vector2op
{
    ...
    >
    inline static constexpr auto normalize(
        const vector_type& vector, 
        numeric_type normalize_value = 1.0
    )
    {
        using calc_type = typename std::conditional<
            std::is_void<_calc_type>::value,
    ...
    template<typename vector_type>
    inline static constexpr auto dot_product(
    ...
    template<
        ...
        typename vector_type = alg_tuple2i
    >
    inline static constexpr auto cos_angle(
        const vector_type& vec1,
        const vector_type& vec2
    )
    {
    ...
    template<
        typename calc_type   = void,
        typename vector_type = alg_tuple2i
    >
    inline static constexpr auto angle(
        const vector_type& vec1,
        const vector_type& vec2
    )
    {
    ...
    template<typename vector_type>
    inline static constexpr auto pseudo_scalar_product(
        const vector_type& vec1,
        const vector_type& vec2
    )
    {
    ...
    template<
        ...
        typename vector_type = alg_tuple2i
    >
    inline static constexpr auto sign_angle(
        const vector_type& vec1,
        const vector_type& vec2
    )
    {
