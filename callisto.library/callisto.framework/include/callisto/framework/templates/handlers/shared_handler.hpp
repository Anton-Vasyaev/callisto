...
#pragma region methods
    ...
    void reset(data_type data) { this->create_new(data); }
...
#pragma region getters_and_setters
    ...
    data_type& get_data() { return this->data; }

    const data_type& get_data() const { return this->data; }

    size_t count() const { return *(this->ref_counter); }

    bool has_handler_status() const { return this->has_handler; }
