...
public:
    ...
    explicit constexpr step_slice(value_type idx) noexcept
    {
        _start_val = idx;
        _end_val   = idx + 1;
        _step_val  = 1;
    ...
    constexpr step_slice(start_type start, end_type end) noexcept
    {
        _start_val = start;
        _end_val   = end;
    ...
    /// @param end End index.
    /// @param step Step.
    constexpr step_slice(size_t start, size_t end, size_t step) noexcept
    {
        _start_val = start;
        _end_val   = end;
        _step_val  = step;
...
#pragma region getters_and_setters
    ...
    /// @return Step.
    constexpr size_t step() const noexcept { return _step_val; }
