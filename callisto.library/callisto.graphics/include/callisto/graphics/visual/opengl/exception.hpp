...
struct opengl_exception : public virtual callisto::framework::exception
{
};
...
struct opengl_shader_failed_link_exception : public virtual opengl_exception
{
    ...
    explicit opengl_shader_failed_link_exception(const std::string& error_log) :
        error_log(error_log)
    {
    }

    explicit opengl_shader_failed_link_exception(std::string&& error_log)
    {
