...
struct vector3op
{
    ...
    inline static constexpr auto square_of_length(const vector3<type>& vector) noexcept
    {
        auto& x = vector.x;
        auto& y = vector.y;
        auto& z = vector.z;
    ...
    template<typename type>
    inline static constexpr auto length(const vector3<type>& vector) noexcept
    {
    ...
    template<typename type>
    inline static constexpr auto
    cross_product(const vector3<type>& a, const vector3<type>& b) noexcept
    {
