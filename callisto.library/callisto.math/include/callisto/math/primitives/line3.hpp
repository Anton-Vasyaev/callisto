...
struct line3
{
    ...
    static constexpr line3 empty() noexcept { return line3(0, 0, 0, 0, 0, 0); }
...
#pragma region construct_and_destruct
    ...
    constexpr line3(const point3<value_type>& start, const point3<value_type>& end) noexcept
    {
        x1 = start.x;
        y1 = start.y;
        z1 = start.z;
    ...
    constexpr line3(const line3<value_type>& other_line) noexcept
    {
        x1 = other_line.x1;
        y1 = other_line.y1;
        z1 = other_line.z1;
...
#pragma region methods
    ...
    constexpr auto first() const noexcept { return point3<value_type>(x1, y1, z1); }

    constexpr auto second() const noexcept { return point3<value_type>(x2, y2, z2); }
...
#pragma region operators
    ...
    constexpr bool operator==(const line3& other_line) const noexcept
    {
