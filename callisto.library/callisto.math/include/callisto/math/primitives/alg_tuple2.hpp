...
struct alg_tuple2
{
    ...
    static inline constexpr alg_tuple2 empty() { return alg_tuple2(0, 0); }


#pragma region construct_and_destruct

    inline constexpr alg_tuple2() { }

    template<typename type_1, typename type_2>
    inline constexpr alg_tuple2(type_1 v1, type_2 v2)
    {
        this->v1 = v1;
        this->v2 = v2;
    }
    ...
    inline constexpr alg_tuple2(const other_alg_type& values)
    {
        this->v1 = values.v1;
        this->v2 = values.v2;
    }
...
#pragma region operators
    ...
    {
        this->v1 = other_tuple.v1;
        this->v2 = other_tuple.v2;
    ...
    // ADDITION
    template<typename other_type>
    inline constexpr auto operator+(const alg_tuple2<other_type>& other_tuple) const
    {
        using num_type = decltype(this->v1 + other_tuple.v2);

        return alg_tuple2<num_type>(
            this->v1 + other_tuple.v1,
            this->v2 + other_tuple.v2
        );
    }
    ...
    inline constexpr auto operator+(numeric_type value) const
    {
        using num_type = decltype(this->v1 + value);
    ...
    template<typename numeric_type>
    inline constexpr const alg_tuple2& operator+=(numeric_type value)
    {
        this->v1 += value;
        this->v2 += value;
    ...
    template<typename other_type>
    inline constexpr bool operator==(const alg_tuple2<other_type>& other_tuple)
    {
        return this->v1 == other_tuple.v1 && this->v2 == other_tuple.v2;
    }
