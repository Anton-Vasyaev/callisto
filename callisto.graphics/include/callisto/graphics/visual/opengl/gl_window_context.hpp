...
// project macros
#include <terramagnia/graphics/opengl/third_party/include_gl.hpp>
// std
#include <thread>
#include <mutex>
...
private:
	...
	// static callbacks
	static void context_key_callback(GLFWwindow* window, int key, int scancode, int action, int mods);
